...
python3 arm_server.py --detector trt_checkpoints/resnet18_trt_960x540.trt --image_size 1280x720 --detector_size 960x540 --detection_frequency 2 --main_image_scale 0.5 --cam_type demo --mockup_detection

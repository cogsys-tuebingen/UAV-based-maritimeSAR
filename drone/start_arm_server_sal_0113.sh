...
python3 arm_server.py --detector /tmp/model.trt --image_size 1280x720 --detector_size 960x540 --detection_frequency 1 --main_image_scale 0.5 --cam_type demo --saliency --verbose detector

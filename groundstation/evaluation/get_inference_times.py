...
from data_loader.utils import ResizerSquare, ResizerRectangle, AdaptiveResizerSquare
...
def calc_stats(model, coco_gt, coco_pred, coco_pred_img_ids):
...
if __name__ == '__main__':
    ...
    urls = ['https://wandb.ai/martinmessmer/centernet/runs/35ibvxov/overview?workspace=user-martinmessmer'] #RN18, ada False
            #'https://wandb.ai/martinmessmer/centernet/runs/1i9agze3/overview?workspace=user-martinmessmer', #RN18, ada True
            #'https://wandb.ai/martinmessmer/centernet/runs/30py3jkb/overview?workspace=user-martinmessmer', #RN50, ada True
            #'https://wandb.ai/martinmessmer/centernet/runs/1cx8zvgx/overview?workspace=user-martinmessmer', #RN50 ada False
            #'https://wandb.ai/martinmessmer/centernet/runs/362murkn/overview?workspace=user-martinmessmer', #RN101 ada False
            #'https://wandb.ai/martinmessmer/centernet/runs/1r36qm3j/overview?workspace=user-martinmessmer'] #RN101 ada True
    ...
    for run in _iter:
        ...
        wandb_id = run.id
        run.config['image_size'] = 2048

        print(f'\n\n\nThis is a run with coniguration:\n{run_config}')
